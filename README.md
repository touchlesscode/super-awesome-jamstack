...
## Hosting Platforms
### New Favourite
- [Kintohub](https://kintohub.com) - Simple, modern serverless platform for modern web apps on top of Google Cloud
### Others
...
## Programmable Chat Interfaces
- [Textkit](https://developers.statflo.com) - Embed an instant chat interface into any app and load campaigns for sms outreach. Powered by Twilio
- [Twilio Flex](https://flex.twilio.com) - Perfect for calling and contact centers.
- [RocketChat] (https://rocket.chat) - Open Source Chat Framework

## No-Code Platforms
### New Favourites
- [Retool](https://www.retool.com) - Create modern interfaces for public, users, and employees on top of most backend data services. 80+ people.
- [Internal.io] (https://www.internal.io) - Create instant interfaces for internal teams on top of existing data sources
- [Jetadmin.io] (https://www.jetadmin.io) - Simple interfaces for existing staff. Earlier stage.
### Others
...
#### Vendors
- [jamstackstorefront](https://jamstackstorefront.com) - Provides quotes on making a jamstack store
...
- [Elastic Cloud](https://www.elastic.co) - Popular search engine for internal and external use


### Database

- [Hasura](https://www.hasura.com) - Hasura - Instant production-ready GraphQL APIs
...
### Automation
- [Tray](https://tray.io) - Advanced drag-and-drop integration tool
